...
設定：Lighthouse mobile、Performance / SEO / Accessibility / Best Practices。変更前は公開URLの1回値、変更後は公開反映後に同じPCから3回測定した中央値。単発値の揺れを避けるため、9月末も3回の中央値で比較する。
...
| トップ | 変更後・公開3回中央値 | 95 | 100 | 100 | 100 | 2.02秒 | 2.24秒 | 135ms | 0 | 87KiB |
| 札幌 | 変更前・公開 | 68 | 100 | 100 | 100 | 2.5秒 | 10.4秒 | 150ms | 0.001 | 2,054KiB |
| 札幌 | 変更後・公開3回中央値 | 89 | 100 | 100 | 100 | 2.45秒 | 2.64秒 | 99ms | 0 | 79KiB |

主な変更は、約1.7MBのトップPNG、約688KBのヘッダーロゴ、エリアヒーロー、リネン画像を軽量化し、外部Webフォントと初期TimeRex読込を表示経路から外したこと。公開実測で、トップの転送量は約97%、札幌は約96%減少した。
